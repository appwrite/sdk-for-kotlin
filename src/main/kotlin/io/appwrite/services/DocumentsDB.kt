...
class DocumentsDB(client: Client) : Service(client) {
    ...
    suspend fun listSpecifications(): io.appwrite.models.DedicatedDatabaseSpecificationList {
        val apiPath = "/documentsdb/specifications"
        val apiParams = mutableMapOf<String, Any?>()
        val apiHeaders = mutableMapOf<String, String>(
            "X-Appwrite-Project" to client.config["project"].orEmpty(),
            "accept" to "application/json",
    ...
    suspend fun createFailover(
        ...
        val apiPath = ("/documentsdb/{databaseId}/failovers"
            .replace("{databaseId}", databaseId)
        )
        val apiParams = mutableMapOf<String, Any?>(
    ...
    suspend fun listOperations(
        ...
        val apiPath = ("/documentsdb/{databaseId}/operations"
            .replace("{databaseId}", databaseId)
        )
        val apiParams = mutableMapOf<String, Any?>(
            "status" to status,
    ...
    suspend fun getReplicas(
        ...
        val apiPath = ("/documentsdb/{databaseId}/replicas"
            .replace("{databaseId}", databaseId)
        )
        val apiParams = mutableMapOf<String, Any?>()
        val apiHeaders = mutableMapOf<String, String>(
    ...
    suspend fun getStatus(
        ...
        val apiPath = ("/documentsdb/{databaseId}/status"
            .replace("{databaseId}", databaseId)
        )
        val apiParams = mutableMapOf<String, Any?>()
        val apiHeaders = mutableMapOf<String, String>(
