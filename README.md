...
**This SDK is compatible with Appwrite server version latest. For older versions, please check [previous releases](https://github.com/appwrite/sdk-for-kotlin/releases).**
...
```groovy
implementation("io.appwrite:sdk-for-kotlin:13.1.1")
```
